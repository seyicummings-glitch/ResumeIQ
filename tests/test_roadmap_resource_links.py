...
def test_serialize_roadmap_attaches_curated_resource_links(db_session):
    ...
    db_session.add(SkillResource(skill_key="docker", skill_label="Docker", youtube_url="https://youtube.com/docker", course_url="https://course.com/docker", docs_url="https://docs.docker.com"))
    db_session.commit()
    ...
    assert topic["resource_links"] == {
        "youtubeUrl": "https://youtube.com/docker",
        "courseUrl": "https://course.com/docker",
